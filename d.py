...
me=Tk()
me.geometry("354x460+600+150")
me.title("CALCULATOR")
me.iconbitmap("C:\\Users\\hp\\Desktop\\cal_icon.ico")
me.resizable(False,False)
melabel = Label(me,text="CALCULATOR",bg='white',font=("Verdana",30,'bold'))
...
metext=Entry(me,font=("Courier New",12,'bold'),textvar=textin,width=25,bd=5,bg='skyblue')
metext.pack()
